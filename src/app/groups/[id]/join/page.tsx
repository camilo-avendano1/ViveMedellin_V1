  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-green-800 mb-4">Unirse al {groupDetails.name}</h1>
        <p className="text-gray-700 mb-4">{groupDetails.description}</p>
        <p className="text-gray-500 mb-8">Miembros Actuales: {groupDetails.members}</p>
